...
-- 2. Tabela klientów (dziedziczy logicznie z users)
...
-- 3. Tabela pracowników (dziedziczy logicznie z users)
...
-- 9. Tabela transakcji (zakupy paliwa i myjni)
...
-- 13. Tabela promocji (program lojalnościowy)
